...
uidNumber=2006
gidNumber=2000
GRUPO_DEFECTO="cn=grupo1,ou=grupos,dc=examen,dc=com"

# Credenciales LDAP
LDAP_ADMIN="cn=admin,dc=examen,dc=com"

# Crear archivo LDIF
ldif="/home/usuario/examen/usuarios.ldif"
echo "" > "$ldif"

# Crear archivo de informe generado
informe="/home/usuario/examen/informe_usuarios.txt"
echo -e "${AZUL}                     Informe de Usuarios Creados${NC}" > "$informe"
echo -e "${AZUL}===============================================================================${NC}" >> "$informe"
echo -e "${AZUL}UID\tNombre\tApellido\tCorreo\tUsuario\tFecha Creación${NC}" >> "$informe"
echo -e "${AZUL}===============================================================================${NC}" >> "$informe"
echo ""
echo "" >> "$informe"
...
crear_usuario() {
    ...
    echo -e "$((uidNumber - 2005))\t$NOMBRE\t$APELLIDO\t$MAIL\t$USUARIO\t$fecha_creacion" >> "$informe"
